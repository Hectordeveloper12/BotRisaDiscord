const {Events, ChannelType, PermissionsBitField, EmbedBuilder, ButtonBuilder, ActionRowBuilder, ButtonStyle, channelLink} = require('discord.js');
        ...
        const selected = interaction.values[0];
         if (selected === 'option3') {
            ...
            const channel = await guild.channels.create({
                name: `ajuda-${interaction.user.id}`,
                type: ChannelType.GuildText,
                parent: '1236353311834112010',
